...
<div class="row">
    <div class="col-lg-12">
        <h4 class="page-header panel-green" style="margin-top:5px;">AUTORISATION DE STATIONNEMENT</h4>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
...
include('dbconnexion.php');
					...
					<option value='' selected>&ndash; Choisir &ndash;</option>\n";
						...
						$query1 ="SELECT lib_type_service,code_type_service FROM type_service  WHERE IdType_quit='AS' order by lib_type_service";
...
?>
                                ...
                                <input class="form-control" type="text" style="text-transform: capitalize;width:150px;margin-bottom:5px;" onkeydown="upperCaseF(this)" name="numero_serie" id="numero_serie" value="" required />
                            </div>
                            
                                  <div class="" id="nbrplacediv">
                                 <label class="label_form">Nbre Place</label>
                                <input class="form-control" type="text" style="text-transform: capitalize;width:150px;margin-bottom:5px;" onkeydown="upperCaseF(this)" name="nombre_place" id="nombre_place" value="" required />
                            </div>


                               <div class="" id="patcdiv">
                                 <label class="label_form">PATC</label>
                                <input class="form-control" type="text" style="text-transform: capitalize;width:150px;margin-bottom:5px;" onkeydown="upperCaseF(this)" name="PTAC" id="PTAC" value="" required />
                            </div>
...
<script>
    ...
    //console.log("je suis dans le declencheur");
       $("#page-wrapper").load("liste_autorisation_stationnement.php");
    });
        ...
        success : function(data) {
          ...
          //  alert('Enregistrer');
           document.getElementById('mess').innerHTML = data.Motif;
            ...
            $("#includedContent").load("liste_autorisation_stationnement.php");
            }
...
$(document).ready(function() {
   ...
   $('#acte').val('');
	...
	$('#numseriediv').find('input').val(sessionStorage.numero_serie);
	...
	$('#genrediv').find('input').val(sessionStorage.genre_vehicule);
	$('#nbrplacediv').find('input').val(sessionStorage.nombre_place);
	$('#marquediv').find('input').val(sessionStorage.marque_vehicule);
	$('#typediv').find('input').val(sessionStorage.type_vehicule);
