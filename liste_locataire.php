...
?>
 ...
 ?>
   <div class="row">
        <div class="col-lg-12">
            <h4 class="page-header" align="center">NOMBRE TOTAL DE BIEN DISPONIBLE<?php echo(' ' . $nbre_bien);?></h4>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default panel-green">
              <div class="panel-heading">
                <div class="clearfix">
                  <h4 class="panel-title pull-left" style="padding-top: 7.5px;">LISTE DES BIENS DISPONIBLE</h4>
...
?>
		...
		<tr>       
                  ...
                  <td><button name="BoutonDetail" type="button" onclick="ouvrefen('<?php echo $V_id_bien; ?>')" class="btn btn-success" id="BoutonDetail">Louer</button></td>
