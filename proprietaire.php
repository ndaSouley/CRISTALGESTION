...
?>
                            ...
                            <div class="col-lg-12" id="loyerdiv">
                                <label class="label_form">Loyer initial</label>
                                <input class="form-control" type="text"  onkeydown="upperCaseF(this)" name="montant" id="montant" value="" ><!--<label class="label_form" style="margin-left:10px">FCFA</label>-->
                            </div>
...
?>
                            ...
                            <div class="col-lg-12" id="loyer_finaldiv">
                                ...
                                <input class="form-control" type="text"  onkeydown="upperCaseF(this)" name="loyer_final" id="loyer_final" value="" required readonly="readonly"><!--<label class="label_form" style="margin-left:10px">FCFA</label>-->
                            </div>
                            <div class="col-lg-12" id="frais_agencediv">
                                <label class="label_form">Frais d'agence</label>
                                <input class="form-control" type="text"  onkeydown="upperCaseF(this)" name="frais_agence" id="frais_agence" value="" required readonly="readonly"><!--<label class="label_form" style="margin-left:-5px">FCFA</label>-->
                            </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <option disabled selected value>&ndash; Choisir &ndash;</option><option value='1'>Oui</option>
                                </option><option value='0'>Non</option>
    ...
    $("#categorie_bien").change(function()
    {
        ...
        $.ajax({
         ...
         if (data.id_categorie_bien==10){
			...
			nbre_place_garagediv.style.display = "blocnonek"
			
			 nbre_pi_div.style.display ="block"
			  nbre_piece.style.display ="block"
