			 ...
			 if(($_POST['action'])== "INSERT") {
				...
				$insquery = "INSERT INTO service(id_abonn_serv,
					...
					$stmt->execute(array(":id_abonn_serv" => $id_abonn_serv,
											...
											":code_periode" => $exercice,
											":montant_previsionnel" =>($droit_de_place + $montant_mensuel)*12
										));  	
						$stmt->closeCursor();				
				$msgexecute	= "TAXE FORFAITAIRE AJOUTE AVEC SUCCES! VOULEZ-VOUS CONTINUER LA SAISIE?";
