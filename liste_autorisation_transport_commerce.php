        ...
        <div class="col-lg-12">
            <div class="panel panel-default panel-green">
              <div class="panel-heading">
                <div class="clearfix">
                  <h4 class="panel-title pull-left" style="padding-top: 7.5px;">LISTE AUTORISATION DE TRANSPORT</h4>
...
include('dbconnexion.php');
	...
	$quittance = "<script>sessionStorage.type_quittance; </script>";
			...
			WHERE
			quittance.Id_Type_quit ='ATPuV' OR quittance.Id_Type_quit ='ATPrV'";
    ...
    //var mat = mle;
        ...
        $.ajax({
			...
			console.log('retour =  '+mat);
				...
				sessionStorage.itineraire = data.itineraire;
				sessionStorage.departement = data.departement;
				sessionStorage.numero_patente = data.numero_patente;
				sessionStorage.region = data.region;
				sessionStorage.place_assise = data.place_assise;
				...
				sessionStorage.place_debout = data.place_debout;
				sessionStorage.date_habilitation = data.date_habilitation;
				sessionStorage.date_visite = data.date_visite;
				...
				sessionStorage.date_doc = data.date_doc;
				sessionStorage.date_validite = data.date_validite;
				sessionStorage.num_plaque = data.num_plaque;
				sessionStorage.Lib_Type_quit = data.Lib_Type_quit;
				sessionStorage.Id_Type_quit = data.Id_Type_quit;
                }                       
                
            });
            
        $("#page-wrapper").load("autorisation_demande_transport_commerce.php");
    }
