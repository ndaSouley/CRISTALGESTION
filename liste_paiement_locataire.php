...
?>
 ...
 include('dbconnexion.php');
	...
	$date_jour=$date_enreg = date('Y-m-d');
 ...
 $date_jour12=$date_enreg = date('Y-m-d');
 ...
 ?>
    ...
    <div class="row">
        <div class="col-lg-12">
            <h4 class="page-header" align="center"></h4>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default panel-green">
              ...
              <div class="panel-heading">
                <div class="clearfix">
                  <h4 class="panel-title pull-left" style="padding-top: 7.5px;">ETAT DES REGLEMENTS JOURNALIER DES LOCATAIRES </h4>
...
//include('dbconnexion.php');
			...
			$query = "SELECT
							...
							AND reglement_locataire.id_locataire= locataire.id_locataire
							AND reglement_locataire.Id_mode_paiement= mode_reglement.id_mode_reglement
							AND reglement_locataire.date_dernier_versement='".$date_jour_1."'
				 			 GROUP BY locataire.nom_locataire 
	...
	else
	{
		...
		while($row = $result->fetch_array(MYSQLI_ASSOC))
		{
			...
			$Mt_restant_loyer = utf8_decode($row['Mt_restant_loyer']);
			...
			$date_enregistrement = utf8_encode($row['date_dernier_versement']);
			// Code pour formater une dans y-m-d en -d-m-y
                  $newDate = date("d-m-Y", strtotime($date_enregistrement));
...
?>
		...
		<tr>       
                  ...
                  <td><?php 
                   ...
                   <td><?php 
						   echo number_format($Mt_restant_loyer) . ' FCFA  ';
                  ...
                  <td> <a href="quittance_de_loyer.php?Id_bien_envoye=<?php echo($V_id_bien);?>" target="_bloank"><button name="BoutonDetail" type="button"  class="btn btn-success" id="BoutonDetail" ><img src="css/images/imprimante.png" alt="Image de modification" width="35" height="35"></button></a></td>
