			 ...
			 if(($_POST['action'])== "INSERT") {
				...
				$insquery = "INSERT INTO proprietaire(nom_proprietaire,
					...
					$stmt->execute(array(":nom_proprietaire" => $nom,
										...
										/*$ninitial_ok=$initial.''.$id_proprietaire;
										
										
										$insquery = "UPDATE  proprietaire   SET initial_proprietaire =:initial_proprietaire
												     WHERE id_proprietaire =:id_proprietaire";
												
					$stmt = $DBcon->prepare($insquery);
					$stmt->execute(array(":initial_proprietaire" => $ninitial_ok,
