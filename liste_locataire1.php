...
$id_user=$_SESSION['TaxeUserData'][0]['id_user'];
 ...
 ?>
   <div class="row">
        <div class="col-lg-12">
            <h4 class="page-header" align="center">TOTAL DES LOCATAIRES<?php echo(' ' . $nbre_bien);?></h4>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
...
include('dbconnexion.php');
	...
	else
	{
		...
		while($row = $result->fetch_array(MYSQLI_ASSOC))
		{
			...
			$V_nom_locataire=$nom_locataire . ' ' . $prenoms_locataire;
			...
			//$Nom_user = utf8_encode($row['Nom_user']);
			//$prenoms_user = utf8_encode($row['prenoms_user']);
			//$agent_saisie=$Nom_user . ' ' . $prenoms_user;
...
?>
		...
		<tr>       
                 <td><?php echo $newDate; ?></td>
                  ...
                  <td><?php echo $V_nom_locataire; ?></td>
                 ...
                 <td> <a href="contrat_baille_habitation.php?Id_bien_envoye=<?php echo($V_id_bien);?>" target="_bloank"><button name="BoutonDetail" type="button"  class="btn btn-success" id="BoutonDetail" ><img src="css/images/imprimante.png" alt="Image de modification" width="35" height="35"></button></a></td>
             <td><button name="BoutonDetail" type="button" onclick="ouvrefen('<?php echo $V_id_bien; ?>')" class="btn btn-success" id="BoutonDetail">Détail</button></td>
             <td><button name="BoutonDetail" type="button" onclick="sortir('<?php echo $V_id_bien; ?>')" class="btn btn-success" id="BoutonDetail">Sortir</button></td> 
...
?>
   ...
   <script>    
    ...
    //var mat = mle;
        ...
        var donnees = {action:"REQUETE_SORTIE",V_id_bien:tr}; 
        console.log('{"action":"REQUETE_SORTIE","V_id_bien":'+tr+'}');     
        ...
        $.ajax({
                ...
                //console.log('retour');
			console.log('retour =  '+tr);
			    sessionStorage.id_bien = tr;
                sessionStorage.even = "UPDATE";
				
				
						sessionStorage.frais_de_gestion = data.frais_de_gestion;
						sessionStorage.caution = data.caution;
						...
						sessionStorage.fonction_locaaire = data.fonction_locataire;
						sessionStorage.e_maill_locattaire = data.e_maill_locataire;
						sessionStorage.num_appartement = data.num_appartement;
						sessionStorage.date_entree_locataire = data.date_entree_locataire;
        ...
        $("#page-wrapper").load("sortir_locataire.php");
    }
    ...
    //var mat = mle;
        ...
        var donnees = {action:"REQUETE_DETAIL_LOCATAIRE",V_id_bien:mat}; 
        console.log('{"action":"REQUETE_DETAIL_LOCATAIRE","V_id_bien":'+mat+'}');     
        ...
        $.ajax({
			...
			console.log('retour =  '+mat);
                ...
                sessionStorage.even = "UPDATE";
						...
						console.log('nom du locataire =  '+data.nom_locataire);
        ...
        $("#page-wrapper").load("locataire_update.php");
    }
