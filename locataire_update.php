...
<div class="row">
    <div class="col-lg-12">
        <h4 class="page-header " style="margin-top:10px;">MODIFICATION DU LOCATAIRE</h4>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="" id="cnisejourdiv">
                                ...
                                <input class="form-control" type="text" style="text-transform: capitalize;width:150px;margin-bottom:5px;" onkeydown="upperCaseF(this)" name="cnisejour" id="cnisejour" value=""  >
                            </div>
                           ...
                           <!-- <div class="" id="quartierdiv">
                            ...
                            <div class="" id="frais_de_gestiondiv">
                                <label class="label_form">Frais de gestion</label>
...
?>
                             ...
                             <div class="" id="num_apptdiv">
                                <label class="label_form">N° Appt</label>
                                <input class="form-control" type="text" style="text-transform: capitalize;width:150px;margin-bottom:5px;" onkeydown="upperCaseF(this)" name="num_appt" id="num_appt" value="" required readonly>
                            </div>
...
?>
                            ...
                            <div class="" id="nomdiv">
                             ...
                             <div class="" id="descriptiondiv">
                                ...
                                <textarea name="description" id="description" style='width:400px;height:100px;' placeholder="DESCRIPTION"></textarea>
                            </div>
...
<script>
    ...
    //console.log("je suis dans le declencheur");
        $("#page-wrapper").load("liste_locataire1.php");
    });
    ...
    {
        $("#includedContent").load("liste_locataire1.php");
    });
...
//    alert("submit form");
    ...
    // console.log('donnees = '+data);
	 ...
	 var v_id_locataire =   sessionStorage.id_locataire;
	 
 var donnees = {action:"MISE_A_JOUR",
					...
					v_id_locataire:v_id_locataire,
					commune:commune,
					V_comission:V_commission,
					fraism_agence:frais_agence,
					loyer_final:loyer_final,
					
					};
					
	               console.log('{"action":'+sessionStorage.even+',"nom":'+nom+',"prenom":'+prenom+',"datenaissance":'+datenaissance+',"lieunaissance":'+lieunaissance+',"cnisejour":'+cnisejour+',"telephone":'+telephone+'/,"profession":'+profession+',"type_bien":'+type_bien+',"localite":'+localite+',"num_impot":'+num_impot+',"commune":'+commune+',"Commission":'+V_commission+',"frais_agence":'+frais_agence+',"loyer_final":'+loyer_final+'}');
...
$(document).ready(function() {
   ...
   $('#telephone1').val('');
	...
	$('#cautiondiv').find('input').val(sessionStorage.caution);
	$('#frais_de_gestiondiv').find('input').val(sessionStorage.frais_de_gestion);
   ...
   $('#cautiondiv').find('input').val(sessionStorage.caution);
	...
	$('#date_entre_div').find('input').val(sessionStorage.date_entree_locataire);
	$('#num_apptdiv').find('input').val(sessionStorage.num_appartement);
