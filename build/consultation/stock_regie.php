...
<input class="form-control" type="date" style="text-transform: capitalize;width:150px;margin-left:30px;padding:20px" onkeydown="upperCaseF(this)" name="date_fin" id="date_début" value="" required>
                      </div>
					</br>
                     <div class="form-group" style="margin-left:50px">
