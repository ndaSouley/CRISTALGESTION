                    ...
                    <td rowspan="4"><div class="form-group">
                      ...
                      <div class="form-group" style="margin-left:50px">
                        <label class="control-label"> Date début:</label>
                            <input class="form-control" type="date" style="text-transform: capitalize;width:150px;margin-left:30px;padding:20px" onkeydown="upperCaseF(this)" name="date_debut" id="date_debut" value="" required>
                      </div>
                          </br>
                     <div class="form-group" style="margin-left:50px">
                        <label class="control-label"> Date fin:</label>
                            <input class="form-control" type="date" style="text-transform: capitalize;width:150px;margin-left:30px;padding:20px" onkeydown="upperCaseF(this)" name="date_fin" id="date_fin" value="" required>
                      </div>
