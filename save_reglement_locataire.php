        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default panel-green">
              <div class="panel-heading">
               ...
               <div id="id_bien_okdiv">
               <input type="text" id="id_bien_ok" value="">
               </div>
...
include('dbconnexion.php');
  ...
  /*$variable_php = '<script type="text/javascript">document.write(ID_bien);</script>';
  echo ' Je suis le ID bien ' .$variable_php;*/
...
?>
		...
		<tr>       
                 <td style="color:#006600"; id="test"><input type="text" ></td>
...
?>
                              ...
                              <div class="col-lg-3" >
                                ...
                                <label class="label_form">Mt Total à Payer</label>
                                 <input class="form-control" type="text"  onkeydown="upperCaseF(this)" name="mt_total_payer" id="mt_total_payer" value=<?php echo($mt_total_payer);?> readonly >
                            </div>
...
$(document).ready(function() {
   ...
   $('#telephone1').val('');
	...
	//console.log('je suis e ID du bien  '+sessionStorage.id_bien);
	...
	//console.log(sessionStorage.id_bien);
