        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default panel-green">
              ...
              <div class="panel-heading">
                <div class="clearfix">
                  <h4 class="panel-title pull-left" style="padding-top: 7.5px;">LISTE DES PROPRIETAIRES POUR LA VENTE </h4>
...
?>
		...
		<tr>       
                  ...
                  <td><?php echo number_format($loyer_proprietaire) . ' FCFA  '; ?></td>
              ...
              <td> <a href="mondat_gestion.php?Id_bien_envoye=<?php echo($id_bien);?>" target="_bloank"><button name="BoutonDetail" type="button"  class="btn btn-success" id="BoutonDetail" ><img src="css/images/imprimante.png" alt="Image de modification" width="35" height="35"></button></a></td>
                  ...
                  <td><button name="BoutonDetail" type="button" onclick="ouvrefen('<?php echo $id_bien; ?>')" class="btn btn-success" id="BoutonDetail">Détail</button></td>
...
?>
   ...
   <script>    
    ...
    //var mat = mle;
        ...
        $("#page-wrapper").load("proprietaire_vente.php");
    }
