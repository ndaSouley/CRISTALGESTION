...
<tr>       
                  ...
                  <td><input class="form-control" type="text" style="text-transform: capitalize;width:150px;margin-bottom:5px;padding:10px" onkeydown="upperCaseF(this)" name="datecde" id="datecde" value="" required></td>
                             <td><input class="form-control" type="text" style="text-transform: capitalize;width:150px;margin-bottom:5px;padding:10px" onkeydown="upperCaseF(this)" name="datecde" id="datecde" value="" required></td></tr>
                        </tbody>
          </table>
                  <!-- /.table-responsive -->
                </div>
