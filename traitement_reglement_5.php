...
//$data = json_decode($InputJsonString, true);
	...
	//VARIABLES REGLEMNTS DU LOYER LOCATAIRE
				...
				$newDate = date("m", strtotime($date_loyer));
		...
		$insquery = "INSERT INTO calendrier_paie(id_locataire,
					...
					$stmt->execute(array(":id_locataire" => $REQ_id_locataire,
								...
								$id_calendrier_reglement_locataire = $DBcon->lastInsertId();
											...
											$rest_cal= $mt_verse - $Loyer_locataire; 
											
									if($rest_cal<$Loyer_locataire){
		...
		$insquery = "INSERT INTO reglement_locataire(id_locataire,
					...
					$stmt->execute(array(":id_locataire" => $REQ_id_locataire,
											...
											":date_reglement" => $date_loyer,
											":Mt_verse" => $mt_verse,
											":Mt_restant" => $Loyer_locataire - $rest_cal,
											":Mt_penalite" => $penalite,
											":Loyer_locataire" => $rest_cal,
											":frais_penalite_agence" => 0,
											":Id_mode_paiement" => $mode_reglement,
											":Mt_travaux" => 0,
											":Mt_charge" => 0
		...
		$insquery = "INSERT INTO calendrier_paie(id_locataire,
					...
					$stmt->execute(array(":id_locataire" => $REQ_id_locataire,
								...
								$id_calendrier_reglement_locataire = $DBcon->lastInsertId();
										...
										//$message='JE SUIS BIEN ICI hooooooooooooo';
		...
		$insquery = "INSERT INTO calendrier_paie(id_locataire,
					...
					$stmt->execute(array(":id_locataire" => $REQ_id_locataire,
								...
								$id_calendrier_reglement_locataire = $DBcon->lastInsertId();
										...
										}elseif($rest_cal>$charge){
											
											// DEUXIEME CALCUL MATHEMATIQUE
											
											$REST_CAL_2 = $rest_cal - $charge;
		...
		$insquery = "INSERT INTO reglement_locataire(id_locataire,
					...
					$stmt->execute(array(":id_locataire" => $REQ_id_locataire,
											...
											":Mt_penalite" => $penalite,
											":Loyer_locataire" => $Loyer_locataire,
											":frais_penalite_agence" => $REST_CAL_2,
											":Id_mode_paiement" => $mode_reglement,
											":Mt_travaux" => $charge,
											":Mt_charge" => $charge
		...
		$insquery = "INSERT INTO calendrier_paie(id_locataire,
					...
					$stmt->execute(array(":id_locataire" => $REQ_id_locataire,
								...
								$id_calendrier_reglement_locataire = $DBcon->lastInsertId();
														...
														}// Fin $charge =='' && $penalite ==0 && $mt_verse <= $Loyer_locataire
		...
		$insquery = "INSERT INTO reglement_locataire(id_locataire,
			...
			//$payer='1';					
					...
					$stmt = $DBcon->prepare($insquery);
					$stmt->execute(array(":Fevrier" => $payer,
											":id_calendrier_paie" => $Calendrier_paie_1['id_calendrier_paie']
											));
		...
		$insquery = "INSERT INTO reglement_locataire(id_locataire,
			...
			//$payer='1';					
					...
					$stmt->execute(array(":Mars" => $payer,
								...
								$message='OOOOOOH CONTACTER L\'ADMINISTRATEUR SVP!!!';
