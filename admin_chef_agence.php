            ...
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="#" onClick="affiche('liste_proprietaire.php');">Propriètaire</a>
                            </li>
                           
                        </ul>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="#" onClick="affiche('liste_locataire.php');"> Biens</a>
                            </li>
                            <li>
                        ...
                        <!--<ul class="nav nav-second-level">
                            <li>
                                <a href="#" onClick="affiche('liste_contact.php');">Proprietaire</a>
                            </li>
                        ...
                        <!--<li>
                        <a href="#" ><i class="fa fa-table fa-fw"></i> Gestion de Stocks<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="#" onClick="affiche('liste_contact.php');">Commandes</a>
                            </li>
                           
                        </ul>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="#" onClick="affiche('liste_contact.php');">Livraison</a>
                            </li>
                           
                        </ul>
                         <ul class="nav nav-second-level">
                            <li>
                                <a href="#" onClick="affiche('liste_contact.php');">Etats de Stocks</a>
                            </li>
                        ...
                        <li>
                        <a href="#" ><i class="fa fa-table fa-fw"></i> Gestion de Contacts<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="#" onClick="affiche('liste_contact.php');">Agenda Cristal</a>
                            </li>
                   ...
                   <!-- </li>-->
                     ...
                     <li class="col">
                        ...
                        <a href="deconnexion.php"> <i class="fa fa-sign-out"><strong>Déconnecter</strong></i></a>
