        ...
        <div class="col-lg-12">
            <div class="panel panel-default panel-green">
              <div class="panel-heading">
                <div class="clearfix">
                  <h4 class="panel-title pull-left" style="padding-top: 7.5px;">LISTE DES DEMANDES D'AUTORISATIONS</h4>
...
?>
    ...
    //var mat = mle;
        ...
        $("#page-wrapper").load("demande_autorisation.php");
    }
